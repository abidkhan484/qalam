...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary: Deep teal/green - Islamic aesthetic
        primary: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
      ...
      fontSize: {
        // Arabic text sizes
        'arabic-sm': ['1.25rem', { lineHeight: '2' }],      // 20px - mobile
        'arabic-base': ['1.5rem', { lineHeight: '2.25' }],  // 24px - tablet
        'arabic-lg': ['1.75rem', { lineHeight: '2.5' }],    // 28px - desktop
        'arabic-xl': ['2rem', { lineHeight: '2.75' }],      // 32px - large
      },
      spacing: {
        // 8px grid system
        '18': '4.5rem',
