 ...
 * Separated from HTTP logic for maintainability
 */

/**
 * Translation assessment prompt template
 * Placeholders: {ARABIC}, {REFERENCE}, {WORD_MEANINGS}, {USER_TRANSLATION}
 */
...
/**
 * Build the assessment prompt with actual values
 */
